...
/**
 * Title: Comments
 * Slug: spiekermann/hidden-comments
 * Inserter: no
 */
?>
				...
				<div class="wp-block-columns is-not-stacked-on-mobile"
					...
					<div class="wp-block-column">
						...
						<div class="wp-block-group hide-empty">
							<!-- wp:comment-reply-link {"className":"is-style-spiekermann-comment-reply-link"} /-->

							<!-- wp:comment-edit-link {"className":"is-style-spiekermann-comment-edit-link"} /-->
						</div>
						<!-- /wp:group -->
