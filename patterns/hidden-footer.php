...
<div class="wp-block-group">
	...
	<div class="wp-block-group"
		...
		<div class="wp-block-columns"><!-- wp:column {"width":"30%"} -->
			<div class="wp-block-column" style="flex-basis:30%"><!-- wp:heading {"fontSize":"small"} -->
				<h2 class="wp-block-heading has-small-font-size">
					<?php esc_html_e('About', 'spiekermann');?>
				</h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column">
				<!-- wp:paragraph -->
				<p>
					<?php esc_html_e('I’m Joseph Spiekermann, a Hungarian-American newspaper publisher. Known for revolutionizing journalism, I left a lasting mark in the form of the Spiekermann Prize.', 'spiekermann');?>
				</p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph -->
				<p>
					<?php _e('<a href="#"><em>Read more...</em></a>', 'spiekermann');?>
				</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:30%">
				<!-- wp:heading {"fontSize":"small"} -->
				<h2 class="wp-block-heading has-small-font-size">
					<?php esc_html_e('Follow Me', 'spiekermann');?>
				</h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:column -->
	...
	<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"},"blockGap":"var:preset|spacing|20"},"elements":{"link":{"color":{"text":"var:preset|color|contrast-2"}}}},"textColor":"contrast-2","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"},"fontSize":"x-small"} -->
	<div class="wp-block-group has-contrast-2-color has-text-color has-link-color has-x-small-font-size" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
		...
		<!-- wp:paragraph -->
		<p>
			<?php _e('Theme by <a href="https://andersnoren.se">Anders Norén</a>', 'spiekermann');?>
		</p>
		<!-- /wp:paragraph -->
