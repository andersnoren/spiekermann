...
/**
 * Title: header
 * Slug: spiekermann/hidden-header
 * Inserter: no
 */
?>
	...
	<div class="wp-block-columns is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-stretch">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Blog', 'spiekermann' ); ?>","url":"#"} /-->
				<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Profile', 'spiekermann' ); ?>","url":"#"} /-->
				<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Newsletter', 'spiekermann' ); ?>","url":"#"} /-->
